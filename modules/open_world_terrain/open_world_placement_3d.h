/**************************************************************************/
/*  open_world_placement_brush_3d.h                                       */
/**************************************************************************/
...
class OpenWorldPlacementBrush3D : public Node3D {
	GDCLASS(OpenWorldPlacementBrush3D, Node3D);
	...
	Ref<OpenWorldPlacementBrushPreset> active_preset;
	...
	bool _contains_world_xz(const Vector3 &p_position, const Vector3 &p_center, const Ref<OpenWorldPlacementBrushPreset> &p_preset) const;
	Vector2 _sample_footprint(RandomPCG &r_random, const Ref<OpenWorldPlacementBrushPreset> &p_preset) const;
	Ref<OpenWorldPlacementBrushEntry> _select_entry(RandomPCG &r_random, const Ref<OpenWorldPlacementBrushPreset> &p_preset) const;
	Dictionary _solve_candidates(const Vector3 &p_world_position, const Ref<OpenWorldPlacementBrushPreset> &p_preset, int p_seed, Vector<Candidate> &r_candidates, Vector<int> &r_replaced_indices) const;
...
public:
	...
	void set_active_preset(const Ref<OpenWorldPlacementBrushPreset> &p_value);
	Ref<OpenWorldPlacementBrushPreset> get_active_preset() const { return active_preset; }
	...
	Dictionary preview_brush(const Vector3 &p_world_position, const Ref<OpenWorldPlacementBrushPreset> &p_preset = Ref<OpenWorldPlacementBrushPreset>(), int p_seed = 0) const;
	Dictionary apply_brush(const Vector3 &p_world_position, const Ref<OpenWorldPlacementBrushPreset> &p_preset = Ref<OpenWorldPlacementBrushPreset>(), int p_seed = 0);
