...
public:
	...
	void add_placement(const String &p_stable_id, const Ref<OpenWorldPlacementBrushEntry> &p_entry, const Vector3 &p_position, const Vector3 &p_rotation, const Vector3 &p_scale, const Vector3 &p_terrain_normal, int p_seed, real_t p_spacing_radius);
