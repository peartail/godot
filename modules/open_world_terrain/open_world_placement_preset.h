/**************************************************************************/
/*  open_world_placement_brush_preset.h                                   */
/**************************************************************************/
...
class OpenWorldPlacementBrushPreset : public Resource {
	GDCLASS(OpenWorldPlacementBrushPreset, Resource);
...
public:
	...
	void set_shape(BrushShape p_value);
	BrushShape get_shape() const { return shape; }
	...
	void add_entry(const Ref<OpenWorldPlacementBrushEntry> &p_entry);
	void remove_entry_at(int p_index);
	int get_entry_count() const { return entries.size(); }
	Ref<OpenWorldPlacementBrushEntry> get_entry(int p_index) const;
...
VARIANT_ENUM_CAST(OpenWorldPlacementBrushPreset::BrushShape);
