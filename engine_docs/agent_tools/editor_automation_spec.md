...
- 단계 0과 미결정 4번의 검증을 마쳤다. 다음 세션은 7번을 정하고 단계 1을 시작한다. 명령 이름과 내부 클래스명은 제안이다.
...
아래 1·2·4·5·6은 [기술 검증](editor_automation_stage0_findings.md) 결과로, 3은 결정으로 닫혔다.
남은 미결정은 7(컴파일 오류 메시지 전달)뿐이다.
